...
class GsaaModelTranslated extends _Model {
  ...
  // ignore: public_member_api_docs
  factory GsaaModelTranslated.fromJson(Map json) {
    return _$GsaaModelTranslatedFromJson(Map<String, dynamic>.from(json));
  }

  // ignore: public_member_api_docs
  Map<String, dynamic> toJson() {
    return _$GsaaModelTranslatedToJson(this);
  }
