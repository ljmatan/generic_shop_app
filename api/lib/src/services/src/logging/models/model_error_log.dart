...
/// Model class defining the error log data structure.
///
class GsaaServiceLoggingModelErrorLog {
  const GsaaServiceLoggingModelErrorLog._({
    required this.time,
  ...
  ///
  ///
  factory GsaaServiceLoggingModelErrorLog.fromJson(Map<String, dynamic> json) {
    return GsaaServiceLoggingModelErrorLog._(
