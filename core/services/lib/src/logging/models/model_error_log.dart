...
///
class GsaServiceLoggingModelErrorLog {
  const GsaServiceLoggingModelErrorLog._({
    required this.time,
  ...
  ///
  ///
  factory GsaServiceLoggingModelErrorLog.fromJson(Map<String, dynamic> json) {
    return GsaServiceLoggingModelErrorLog._(
