...
part of '../widget_cookie_consent.dart';

enum GsaWidgetCookieConsentI18N implements GsaServiceI18NBaseTranslations {
  title(
  ...
  confirmSelectionButtonLabel(
    GsaServiceI18NModelTranslatedValue(
      'CONFIRM SELECTION',
      enIe: 'CONFIRM SELECTION',
      enGb: 'CONFIRM SELECTION',
  ...
  declineOptionalButtonLabel(
    GsaServiceI18NModelTranslatedValue(
      'DECLINE OPTIONAL',
      enIe: 'DECLINE OPTIONAL',
      enGb: 'DECLINE OPTIONAL',
      de: 'OPTIONALE ABLEHNEN',
      it: 'RIFIUTA FACOLTATIVI',
      fr: 'REFUSER LES OPTIONNELS',
      es: 'RECHAZAR OPCIONALES',
      hr: 'ODBIJ NEOBAVEZNO',
  ...
  mandatoryCookiesDescription(
    GsaServiceI18NModelTranslatedValue(
      ...
      enIe: 'Mandatory cookies are required to use our products and are necessary for our sites to work as intended.',
      enGb: 'Mandatory cookies are required to use our products and are necessary for our sites to work as intended.',
      de: 'Zwingende Cookies sind erforderlich, um unsere Produkte zu nutzen und damit unsere Website wie vorgesehen funktioniert.',
      it: 'I cookie obbligatori sono necessari per utilizzare i nostri prodotti e far funzionare correttamente i nostri siti.',
      fr: 'Les cookies obligatoires sont nécessaires pour utiliser nos produits et assurer le bon fonctionnement de nos sites.',
      es: 'Las cookies obligatorias son necesarias para utilizar nuestros productos y para que nuestros sitios funcionen correctamente.',
      hr: 'Obavezni kolačići su potrebni za korištenje naših proizvoda i ispravno funkcioniranje naših stranica.',
      cz: 'Povinné soubory cookie jsou nezbytné pro používání našich produktů a správné fungování našich stránek.',
    ),
  ),
  ...
  statisticalCookiesDescription(
    GsaServiceI18NModelTranslatedValue(
      ...
      enIe: 'Statistical cookies collect anonymous data to analyze and understand how visitors interact with our services.',
      enGb: 'Statistical cookies collect anonymous data to analyze and understand how visitors interact with our services.',
      de: 'Statistische Cookies sammeln anonyme Daten, um zu analysieren und zu verstehen, wie Besucher mit unseren Diensten interagieren.',
      it: 'I cookie statistici raccolgono dati anonimi per analizzare e comprendere come i visitatori interagiscono con i nostri servizi.',
      fr: 'Les cookies statistiques collectent des données anonymes pour analyser et comprendre comment les visiteurs interagissent avec nos services.',
      es: 'Las cookies estadísticas recopilan datos anónimos para analizar y comprender cómo interactúan los visitantes con nuestros servicios.',
      hr: 'Statistički kolačići prikupljaju anonimne podatke za analizu i razumijevanje interakcije posjetitelja s našim uslugama.',
      cz: 'Statistické soubory cookie shromažďují anonymní data za účelem analýzy a pochopení interakce návštěvníků s našimi službami.',
    ),
  ),
  marketingCookiesDescription(
    GsaServiceI18NModelTranslatedValue(
      'Marketing cookies are utilized to tailor advertisements and promotional content to your interests.',
      enIe: 'Marketing cookies are utilized to tailor advertisements and promotional content to your interests.',
  ...
  const GsaWidgetCookieConsentI18N(this.value);
