...
///
class GsaServiceLoggingModelGeneralLog {
  const GsaServiceLoggingModelGeneralLog._({
    required this.time,
  ...
  ///
  ///
  factory GsaServiceLoggingModelGeneralLog.fromJson(Map<String, dynamic> json) {
    return GsaServiceLoggingModelGeneralLog._(
